...
export const SCHEDULE_BLOCKS = [
  { id: "m-p2", time: "6:30–8:00", title: "CIL Paper II", desc: "DBMS / OS / CN / DSA / SE — see weekly rotation", track: "cil", xp: 15 },
  { id: "m-dsa", time: "8:00–8:45", title: "DSA (Corporate)", desc: "1 LeetCode — arrays → trees → graphs", track: "corporate", xp: 15 },
  { id: "m-corp", time: "8:45–9:30", title: "Corporate depth", desc: "Ticket Triage / Java / Amdocs — rotate", track: "corporate", xp: 15 },
  { id: "n-p1", time: "9:00–10:30", title: "CIL Paper I", desc: "Reasoning + Quant timed sets", track: "cil", xp: 15 },
  { id: "n-eng", time: "10:30–11:15", title: "English or GK", desc: "Alternate days — RC / grammar / current affairs", track: "cil", xp: 15 },
  { id: "n-rev", time: "11:15–12:00", title: "Revise + explain", desc: "Notes + project story aloud", track: "both", xp: 15 },
];
